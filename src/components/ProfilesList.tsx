...
const renderValue = (
    ...
    if (value === null) {
        return { text: "Not configured", className: "text-gray-400 italic" };
    }

    if (type === "boolean") {
        return {
            text: value ? "Yes" : "No",
            className: value ? "text-accent-success font-semibold" : "text-gray-500 font-semibold",
        };
    }
        ...
        return (
            <div className="card card-accent">
                <div className="card-header">
                    ...
                    <h2 className="text-xl font-semibold text-dark-text">Profiles</h2>
                </div>
                <div className="text-center py-12">
                    <div className="text-4xl mb-4 opacity-50">📋</div>
                    <div className="text-xl font-semibold text-gray-700 mb-2">No Profiles Found</div>
        ...
        <div className="card card-accent">
            ...
            <div className="flex flex-col gap-4">
                {profiles.map((profile, index) => (
                    <div key={profile.realName || index} className="border-l-4 border-l-primary-500 bg-gray-50 rounded-lg p-4 hover:bg-primary-50 transition-all duration-200">
                        <div className="flex justify-between items-start mb-3">
                            <span className="text-lg font-semibold text-dark-text break-words flex-1">{profile.name}</span>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <span className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Real Name</span>
                        ...
                        <div>
                            <span className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Certificate</span>
                        ...
                        <div>
                            <span className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Proxy Server</span>
