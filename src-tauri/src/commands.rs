...
fn patch_profile_file(profile_file_path: &Path, profile: &Profile) -> Result<(), String> {
...
fn patch_hoppie_code(euroscope_config_path: &Path, hoppie_code: &str) -> Result<(), String> {
